...
writeNewBesoin("STYLO", "NON AMORTISSABLE", "MATERIEL DE BUREAU", 3, "0", 2,R.drawable.b21);
        ...
        writeNewBesoin("POUBELLE", "NON AMORTISSABLE","MATERIEL D ENTRETIEN", 2, "0", 0,R.drawable.b10);
        writeNewBesoin("STICKY NOTES", "NON AMORTISSABLE", "MATERIEL DE BUREAU", 3, "0", 2,R.drawable.b17);
        writeNewBesoin("CLIMATISEUR", "AMORTISSABLE", "MATERIEL DE BUREAU", 0, "2020-03-25", 0,R.drawable.b9);
